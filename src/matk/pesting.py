__all__ = ['read_pest', 'read_pest_files', 'write_pest_files',
           'ModelTemplate', 'ModelInstruction']
...
def read_pest(filename):
    ...
    pest_prob = pymads.PyMadsProblem(npar, nobs, ntplfile=ntplfile,
                                     ninsfile=ninsfile, npargrp=mynpargrp,
